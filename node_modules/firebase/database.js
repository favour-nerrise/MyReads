...
(function() {
    ...
    function ge(a, b) {
        var c = b.path.toString(),
            d;
        !(d = !q(b.kc.host) || 0 === b.kc.host.length || !Wd(b.kc.pe)) && (d = 0 !== c.length) && (c && (c = c.replace(/^\/*\.info(\/|$)/, "/")), d = !(q(c) && 0 !== c.length && !Vd.test(c)));
    ...
    function te(a, b, c) {
        ...
        var d = J(b);
        a = a.children.get(d);
        return null !== a ? (b = te(a, D(b), c), null != b ? {
    ...
    g.gb = function(a, b, c) {
        a.type === nd && null !== a.source.Ib && (E(pc(this.Na), "We should always have a full cache before handling merges"), E(Id(this.Na), "Missing event cache, even though we have a server cache"));
        var d = this.Na;
            ...
            if (!c.Bb) {
                c.Wa = new jg(function(a, b, d, k, m) {
                    ...
                    if (c.Wa)
                        ...
                        else if ("close" === a) b ? (c.Wa.Kd = !1, Rb(c.ff, b, function() {
                        c.fb()
                    })) : c.fb();
                    ...
                    if ("c" == d) {
                        if (d = cd("t", c), "d" in c)
                            if (c = c.d, "h" === d) {
                                ...
                                a.yf = c.s;
                                dc(a.M, f);
                                0 == a.L && (a.I.start(), wg(a, a.I, d), "5" !== e && L("Protocol version mismatch detected"), c = a.Af, (c = 1 < c.Wc.length ? c.Wc[1] : null) && xg(a, c))
                            } else if ("n" === d) {
    ...
    function Ig(a, b) {
        ...
        a.va("q", f, function(f) {
            ...
            }(a.aa[d] && a.aa[d][e]) === b && (a.f("listen response", f), "ok" !== m && Jg(a, d, e), b.G &&
                b.G(m, k))
        })
    }
    g.qf = function(a) {
    ...
    g.jg = function(a) {
        a && !this.Nb && this.Va === this.td && (this.f("Window became visible.  Reducing delay."), this.Va = 1E3, this.Ia || Gg(this, 0));
        this.Nb = a
    };
    g.ig = function(a) {
    ...
    g.Jc = function(a, b, c) {
        ...
        var d = null,
            e = null;
        "value" === a ? d = new kh(b || null, null, c || null) : a && (b && (e = {}, e[a] = b), d = new lh(e, null, c || null));
        e = this.u;
    ...
    function Rh(a, b, c) {
        ...
        this.pd = new qh({
            Ae: function(a, b, c, d) {
                b = [];
                c = f.ie.j(a.path);
                c.e() || (b = sh(f.pd, new ac(Ge, a.path, c)), setTimeout(function() {
                    d("ok")
                }, 0));
                return b
            },
    ...
    g.Hb = function(a, b, c, d) {
        ...
        d ? c ? (b = la(b, function(a) {
            ...
            return S(a)
        }), a = vh(this.K, e, d)) : (d = S(b), a = sh(this.K, new ac(Ge, e, d)));
        d = e;
