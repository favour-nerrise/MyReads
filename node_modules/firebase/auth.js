...
(function() {
    ...
    var jd = function(a, b) {
        ...
        fd, gd = function() {
            if (l.Promise && l.Promise.resolve) {
                ...
                var a = kd;
                !p(l.setImmediate) || l.Window && l.Window.prototype && !y("Edge") && l.Window.prototype.setImmediate == l.setImmediate ? (ad || (ad = bd()), ad(a)) : l.setImmediate(a)
            }
        },
        hd = !1,
        id = new cd,
            ...
            return new I(function(b) {
                ...
                if (c)
                    for (var e = function(a, e, f) {
                            ...
                            0 == c && b(d)
                        }, f = 0, g; f < a.length; f++) g = a[f], td(g, ka(e, f, !0),
                        ka(e, f, !1));
                else b(d)
            })
        };
    ...
    */
        ...
        Kd = function(a) {
            ...
            for (var b = a.ka, d = c = !1; a.bc.length && !a.nc;) {
                ...
                if (f = a.nb ? g : f) try {
                    ...
                    if (md(b) || "function" === typeof l.Promise && b instanceof l.Promise) d = !0, a.nc = !0
                } catch (q) {
                    b = q, a.nb = !0, Sd(a) || (c = !0)
                }
            }
    ...
    var ce = "StopIteration" in l ? l.StopIteration : {
    ...
    ne.prototype.log = function(a, b, c) {
        if (a.value >= se(this).value)
            for (p(b) && (b = b()), a = new le(a, String(b), this.se), c && (a.ad = c), c = "log:" + a.re, l.console && (l.console.timeStamp ? l.console.timeStamp(c) : l.console.markTimeline && l.console.markTimeline(c)), l.msWriteProfilerMark && l.msWriteProfilerMark(c), c = this; c;) {
                b = c;
                var d = a;
                if (b.fd)
    ...
    M.prototype.Oa = function() {
        this.a && (this.pa && (this.pa = !1, this.Ba = !0, this.a.abort(), this.Ba = !1), Ie(this, !0));
        M.Pc.Oa.call(this)
    };
    ...
    var Ah = function(a, b, c, d) {
        ...
        Bh, Ch = function() {
            Bh || (Bh = new Ah("firebase", ":", "Safari" == lf(gf()) && l.window && l.window != l.window.top ? !0 : !1, xf()));
            return Bh
        };
    h = Ah.prototype;
    h.K = function(a, b) {
    ...
    Kh.prototype.sd = function(a, b) {
        ...
        var c = a.va,
            d = a.za;
        "unknown" == c ? (this.W || Wh(this, !1, null, null), a = J()) : a = a.J ? this.Gc(a, b) : b.mb(c, d) ? this.Hc(a, b) : K(new R("invalid-auth-event"));
        return a
    };
    var Ph = function(a) {
    ...
    Yh.prototype.getToken = function(a) {
        a = !!a;
        return bi(this) ? K(new R("user-token-expired")) : a || !this.wa || la() > this.Pa - 3E4 ? this.S ? ai(this, {
    ...
    var pi = function(a) {
        return a.getToken().then(function(b) {
            ...
            return qi(a, b).then(function() {
                ...
                "auth/user-token-expired" == b.code && (a.dispatchEvent(new di("userDeleted")), ri(a));
                throw b;
            })
        })
    };
